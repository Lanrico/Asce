...
var live_info_list = [
    ...
    [24090459, 'JPY', 'https://i2.hdslb.com/bfs/face/43b21998da8e7e210340333f46d4e2ae7ec046eb.jpg@240w_240h_1c_1s.webp']
]

// 调用桌面通知

setInterval(function (e) {
    for (var i = 0; i < live_info_list.length; i++) {
        live_notification(live_info_list[i][0], live_info_list[i][1], live_info_list[i][2]);
        // console.log(live_info_list[i][1]);
    }
